...
requirejs(['../src/WorldWind',
    ...
    function (ww,
        ...
        // UI controller for interactively modifying annotation properties
        ...
        for (var z = 0; z < locations.length; z++) {
            ...
            annotation.label = "Click an annotation to select it. \n\n " +
        ...
        // Select a default active annotation and point the camera to it.
        annotationController.load(annotations[4]);
        var lookAtPosition = new WorldWind.Position(annotations[4].position.latitude, annotations[4].position.longitude);
        wwd.goTo(lookAtPosition);
